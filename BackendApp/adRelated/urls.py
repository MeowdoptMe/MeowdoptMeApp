...
from .views import AdList, AdCreate, AdDetail, PetList, PetCreate, PetDetail
...
urlpatterns = [
    ...
    path('<int:id>/pet/', PetDetail.as_view(), name='pet_detail'), #get
    path('<int:id>/add_pet', PetCreate.as_view(), name='pet_create'), #post
]