...
describe('StartingScreen', () => {
  ...
  describe('Registration modal', () => {
    ...
    it("doesn't call 'register' when 'Register' button is pressed with incorrect data", async () => {
    ...
    it("doesn't call register when passwords don't match", async () => {
      const spy = jest.spyOn(authUtils, 'register');
    ...
    it("calls 'register' when 'Register' button is pressed with correct data", async () => {
      const spy = jest.spyOn(authUtils, 'register');
